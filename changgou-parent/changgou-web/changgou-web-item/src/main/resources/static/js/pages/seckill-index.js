...
//             $("#seckill").append(
//                 "<li class='seckill-search'><div class='pic' ><img src='" + list["img"] + "' alt=''></div><div class='intro'><span>" + list["desc"] + "</span></div>"
...
//                 + "</div>"
//                 + "<a class='sui-btn btn-block btn-buy' href='seckill-search.html' target='_blank'>立即抢购</a>"
//                 + "</li >"
//             );
