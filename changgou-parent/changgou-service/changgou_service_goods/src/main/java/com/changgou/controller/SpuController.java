...
public class SpuController {
    ...
    public Result xiajia(@PathVariable Long spuid) {
        spuService.xiajia(spuid);
        return new Result(true, StatusCode.OK, "下架成功");
    }

    @PutMapping("/put/{spuid}")
    public Result shanjia(@PathVariable Long spuid) {
        spuService.shanjia(spuid);
        return new Result(true, StatusCode.OK, "上架成功");
    }

    @PutMapping("/put/many")
    public Result putMany(@RequestBody Long[] ids) {
        int count = spuService.shanjiamany(ids);
        return new Result(true, StatusCode.OK, "上架" + count + "个商品");
    }

    @PutMapping("/pull/many")
    public Result pullMany(@RequestBody Long[] ids) {
        int count = spuService.xiajiamany(ids);
