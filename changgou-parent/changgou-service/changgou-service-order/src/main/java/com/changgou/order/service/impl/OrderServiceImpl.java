...
//
    ...
    @Override
    public void updateStatus(String username, String updatetime, String transaction_id) {
        Order order = (Order) redisTemplate.boundHashOps("orderListenerQueue").get(username);
        if (order != null) {
            try {
                ...
                redisTemplate.boundHashOps("orderListenerQueue").delete(username);
